...
export default function Home() {
  ...
  <p className="mb-6 text-gray-700">Conectando tutors e veterinários para atendimento rápido em situações de emergência. Faça login ou cadastre-se para acessar os serviços!</p>
